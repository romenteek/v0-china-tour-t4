...
const budgetPoints = [
  ...
  "Личные расходы: ~ $50 в день на человека (питание + транспорт), экскурсии и посещение платных достопримечательностей в расчет не входят",
  "В стоимость тура входит посещение всех вечеринок",
  "Возможность присоединиться на любом этапе, стоимость будет рассчитана индивидуально",
